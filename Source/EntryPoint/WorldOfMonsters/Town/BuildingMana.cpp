    ...
    Building()
{
    ...
    // Cost
    const CurrencyCost * pCost = pGameParams->GetBuildingCost( BUILDING_MANA );
...
{
    const GameParameters * pGameParams = GameplayFn->GetGameParameters();
    const CurrencyCost * pCost = pGameParams->GetManaProductionRateUpgradeCost();
...
{
    const GameParameters * pGameParams = GameplayFn->GetGameParameters();
    const CurrencyCost * pCost = pGameParams->GetManaCapacityUpgradeCost();
